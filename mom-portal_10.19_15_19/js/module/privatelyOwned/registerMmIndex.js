require(['/js/zlib/app.js'], function (App) {
    ...
    var PageModule = {
        ...
        renderRContent: function (data, id) {
            ...
            var dataMmhtml = {
                //编码-----*/
                tileTemplateCode: '<tr><td class="active require">编码:</td>' +
                '<td><input id="tileTemplateCode" name="tileTemplateCode" type="text" require="true" value="" class="form-control valid1" > ' +
                ...
                '<td><select id="dataSource" name="dataSource" type="text"  class="form-control select2 valid1" ></select>' +
                '</td></tr>',
                //磁贴大小--*/
