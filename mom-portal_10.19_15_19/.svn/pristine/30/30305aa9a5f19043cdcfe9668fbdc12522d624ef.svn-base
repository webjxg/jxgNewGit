            ...
            function renderTableData(tableData) {
                $('#treeTable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "unitNo", 'sClass': " alignCenter", "width": "5%"},
                        {"data": "unitCode", 'sClass': "alignCenter ", "width": "8%"},
                        {"data": "unitName", 'sClass': "alignCenter", "width": "12%"},
                        {"data": "unitAlias", 'sClass': "alignCenter","width": "12%"},
                        {"data": "unitTypeLabel", 'sClass': "alignCenter","width": "12%"},
                        {"data": "capacity", 'sClass': "alignCenter", "width": '5%'},
