            ...
            function renderTableData(tableData) {
                $('#treeTable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "fctrNo", 'sClass': " alignCenter", "width": "12%"},
                        {"data": "fctrCode", 'sClass': "alignCenter ", "width": "12%"},
                        {"data": "fctrName", 'sClass': "alignCenter", "width": "12%"},
                        {"data": "fctrAlias", 'sClass': "alignCenter","width": "12%"},
                        {"data": "fctrTypeLabel", 'sClass': "alignCenter", "width": '8%'},
