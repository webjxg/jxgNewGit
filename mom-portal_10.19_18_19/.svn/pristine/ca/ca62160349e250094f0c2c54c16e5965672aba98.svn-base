            ...
            function renderTableData(tableData) {
                $('#treeTable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "proCase.caseName", 'sClass': "alignCenter"},
                        {"data": "node.nodename", 'sClass': "alignCenter"},
                        {"data": "mtrl.mtrlName", 'sClass': "alignCenter"},
                        {"data": "fctr.fctrName", 'sClass': "alignCenter"},
                        {"data": "ratioUplimit", 'sClass': "alignCenter"},
                        {"data": "ratioDownlimit", 'sClass': "alignCenter"},
                        {"data": "ratio", 'sClass': "alignCenter"},
