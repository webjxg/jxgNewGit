        ...
        createTable: function (tableDate) {
            $('#treeTable').dataTable({
                ...
                "aoColumns": [
                    ...
                    {"data": "unitGroupId", 'sClass': "alignCenter "},
                    {"data": "unit.unitName", 'sClass': "alignCenter "},
                    {"data": "slineMtrlTypeLabel", 'sClass': "alignCenter "},
                    {"data": "slineInoutTypeLabel", 'sClass': "alignCenter "},
                    {"data": "refSidelineId", 'sClass': "alignCenter "},
                    {"data": "pres", 'sClass': "alignCenter "},
                    {
                        "data": "isRvs", 'sClass': "alignCenter ",
                        "render": function (data, type, row, meta) {
                    ...
                    {
                        "data": "id", "orderable": false, "defaultContent": "", 'sClass': " alignCenter " ,"width":"12%",
                        "render": function (data, type, row, meta) {
