    ...
    var PageModule = {
        listInit: function () {
            ...
            $('#btn-add').on('click', function () {
                Bus.openEditDialog('新增物料', 'material/factoryModels/materialInner.html?id=0', '700px', '405px');
            });
            //编辑
            $('#btn-edit').on('click', function () {
                Bus.editCheckedTable('编辑物料','material/factoryModels/materialInner.html','700px','405px','#treeTable')
            });
            //引入page插件
            ...
            function renderTableData(tableData) {
                $('#treeTable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "mtrlNo", 'sClass': " center"},
                        {"data": "mtrlCode", 'sClass': "center "},
                        {"data": "mtrlName", 'sClass': "center"},
                        {"data": "mtrlAlias", 'sClass': "center"},
                        {"data": "parent.mtrlName", 'sClass': "center"},
                        {"data": "vcfTypeLabel", 'sClass': "center"},
