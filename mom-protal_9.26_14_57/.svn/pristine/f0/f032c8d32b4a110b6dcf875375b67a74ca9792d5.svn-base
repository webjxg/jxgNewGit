require(['/js/zlib/app.js'], function (App) {
    ...
    var PageModule = {
        ...
        renderRContent: function (data, id, results) {
            ...
            var dataMmhtml = {
                /*编码-----*/
                tileTemplateCode: '<tr><th class="" ><label class="pull-right"><font color="red">*</font>编码:</label></th>' +
                '<td class=""><input id="tileTemplateCode" name="tileTemplateCode" type="text" require="true" value="" class="form-control valid" > ' +
                '<label id="tileTemplateCode-error" class="error" for="tileTemplateCode" style="display:none"></label></td></tr>',
                /*应用-----*/
                appCode: '<tr><th class=""><label class="pull-right"><font color="red">*</font>应用:</label></th>' +
                '<td class="">' +
                '<select class="form-control valid" name="appCode" id="appCode" require="true"><option value="">请选择</option></select>' +
                '<label id="appCode-error" class="error" for="appCode"style="display:none"></label></td></tr>',
                /*标题-----*/
                title: '<tr><th class=""><label class="pull-right"><font color="red">*</font>标题:</label></th>' +
                '<td class=""><input id="title" name="title" type="text" require="true" value="" class="form-control valid">' +
                ...
                '<td class="width-80"><select id="dataSource"  name="dataSource" type="text"  class="form-control select2 valid1" ></select>' +
                '<label id="dataSource-error" class="error" for="title" style="display:none"></label></td></tr>',
                /*磁贴大小--*/
                size: '<tr class="sizexy"><th class=""><label class="pull-right">磁贴大小:</label></th>' +
                '<td class="" colspan="3">' +
                ...
                /*描述*/
                des: '<tr><th class=""><label class="pull-right">描述:</label></th>' +
                '<td class="">' +
                '<textarea name="des" rows="4" id="des" class="form-control valid"></textarea></td></tr>',
                /*字段配置*/
                displayName: '<tr><th class=""><label class="pull-right"><font color="red">*</font>字段配置:</label></th>' +
                '<td class=""><input id="displayName" name="displayName" type="text" require="true" value="" class="form-control valid">' +
                '<label id="displayName-error" class="error" for="displayName" style="display:none"></label></td></tr>',
                /*间隔时间*/
                timeInterval: '<tr><th class=""><label class="pull-right">刷新间隔:</label></th>' +
                '<td class=""><input id="timeInterval" name="timeInterval" type="text"  value="" class="form-control valid" style="width:88%">（秒）' +
                '<label id="timeInterval-error" class="error" for="timeInterval" style="display:none"></label></td></tr>',
                /*列名*/
                columnName: '<tr><th class=""><label class="pull-right"><font color="red">*</font>列名:</label></th>' +
                ...
                /*每页条数*/
                pageSize: '<tr><th class=""><label class="pull-right"><font color="red">*</font>每页条数:</label></th>' +
                ...
                /*图片*/
                icon: '<tr><th class=""><label class="pull-right"><font color="red">*</font>图标:</label></th><td class=" "><a href="javascript:" class="" id="filePicker" >选择</a><input id="nameImage" name="icon" maxlength="255" class="input-xlarge form-control valid" type="text" value="0"/></td></tr>',
                /*打开方式*/
                targer: '<tr><th class=""><label class="pull-right"><font color="red">*</font>打开方式:</label></th>' +
                ...
                /*文本内容*/
                content: '<tr><th class=""><label class="pull-right"><font color="red">*</font>文本内容:</label></th>' +
                ...
                '</td></tr>',
                /*图片*/
                icon1: '<tr><th class=""><label class="pull-right"><font color="red">*</font>图片:</label></th><td class=" "><a href="javascript:" class="" id="filePicker" >选择</a><input id="nameImage" name="icon" maxlength="255" class="input-xlarge form-control valid" type="text" value="0"/></td></tr>',
                /*开放类型*/
                ...
                /*图标icon选择*/
                icons: '<tr class="icons"><th class="width-10"><label class="pull-right"><font color="red">*</font>图标:</label></th><td class="width-80"><i id="iconIcon" class="icon iconfont"></i>&nbsp;&nbsp;<input id="icon" name="icon" type="text" class="  valid1" require="true" value><a id="iconButton" href="javascript:" class="btn btn-primary color">选择</a>&nbsp;&nbsp;<input id="iconclear" class="btn btn-default" type="button" value="清除"><label id="icon-error" class="error" for="icon" style="display:none"></label></td></tr>'
            };
        ...
        iconChange: function (data) {
            $('#iconButton').on('click', function () {
                ...
                openEdit('选择图标', 'privatelyOwned/icon-forWorkBench.html?data=' + data + '&class=' + icon, '800px', '600px')
            });
