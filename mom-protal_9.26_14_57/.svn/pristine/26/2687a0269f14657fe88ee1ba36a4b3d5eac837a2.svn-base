            ...
            init: function () {
                ...
                require(['Page'], function () {
                    ...
                    window.pageLoad = function () {
                        ...
                        Page.init(Api.aps + "/api/ob/QualityInspections/page", data, true, function (result) {
                        ...
                        $("#add-btn").unbind("click").on('click', function () {
                            ...
                            function addnewrows() {
                                ...
                                tr = "<tr class='top'>" +
                                    ...
                                    "<input type='checkbox' class='i-checks alignCenter' value=''>" +
                                    '</td>' +
                                    "</tr>";
                                $("#datainner").prepend(tr);
                                for (var i = 0; i < $("thead .sorting_disabled").length - 1; i++) {
                                    td = '<td>' +
                                        "<input type='text' class='content-text alignCenter'/>" +
                                        '</td>';
                                    $("#datainner tr:first").append(td);
                                };
                                $(".content-text").eq(0).addClass('alignCenter').addClass('select2');
                                $(".content-text").eq(2).datetimepicker({
                                    bootcssVer: 3,          //显示箭头，部分如不显示箭头要加这个
                                    format: "yyyy-mm-dd",  //保留到日
                                    showMeridian: true,     //显示上、下午
                                    language: "cn",   //中文显示
            ...
            createTable: function (tableDate) {
                $("#treeTable").dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "oreTypes", 'sClass': "alignCenter ", "width": "8%"},
                        {"data": "supplierName", 'sClass': "alignCenter", "width": "17%"},
                        {"data": "arrivalDate", 'sClass': "alignCenter", "width": "8%"},
                        {"data": "batchNum", 'sClass': "alignCenter"},
