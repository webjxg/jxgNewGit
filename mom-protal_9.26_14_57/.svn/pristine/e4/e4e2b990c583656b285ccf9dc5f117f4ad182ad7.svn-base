    ...
    var PageModule = {
        ...
        renderRContent: function (data, id) {
            ...
            var dataMmhtml = {
                ...
                '<td class="width-80"><input id="tileTemplateCode" name="tileTemplateCode" type="text" require="true" value="" class="form-control valid1" > ' +
                ...
                '<td class="width-80"><input id="title" name="title" type="text" require="true" value="" class="form-control valid1">' +
                ...
                '<td class="width-80"><input id="displayName" name="displayName" type="text" require="true" value="" class="form-control valid1">' +
                ...
                '<td class="width-80"><input id="columnName" name="columnName" type="text" require="true" value="" class="form-control valid1">' +
                ...
                '<td class="width-80"><input id="pageSize" name="pageSize" type="text" require="true" value="" class="form-control valid1">' +
                ...
                '<td class="width-80"><select class="form-control" require="true" name="targer" id="targer"><option value="">请选择</option><option value="0">Tab选项卡</option><option value="1">页签</option></select>' +
                '<input id="targerId" name="targerId" type="hidden" require="true" value="" class="form-control valid1"  >'
                +
                ...
                '<td class="width-80"><textarea name="content" rows="4" id="content" require="true" class="form-control valid1"></textarea>' +
                '<label id="content-error" class="error" for="content" style="display:none"></label></td></tr>',

                //——————背景颜色选择————————*/
                bgColor: '<tr><td class="width-10"><label class="pull-right">背景颜色:</label></td><td class="width-80"><div class="bgColor">' + '<input class="valid1" type="hidden" id="bgColor" name="bgColor" >' +
