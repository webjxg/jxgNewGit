        ...
        listInit: function(){
            ...
            require(['Page'],function(){
                window.pageLoad = function (){
                    ...
                    //修改默认每页显示条数
                    Page.init(Api.admin+"/api/sys/SysRole/page",data,true,function(tableData){
        ...
        listAllotPro: function(){
            ...
            require(['Page'], function () {
                window.pageLoad = function () {
                    ...
                    Page.init(Api.admin+"/api/sys/SysRole/rolePermPage", data, true, function (tableData) {
                        renderTableData(tableData);
                        //分配
                ...
                Api.ajaxJson(allotUrl, {}, function (result) {
                    if (result.success) {
                        ...
                        require(['ztree_all'],function(){
                            ...
                            //绑定筛选框事件
                            require(['treeSelect'],function(treeSelect){
