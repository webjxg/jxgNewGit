    ...
    var PageModule = {
        listInit: function () {
            ...
            $('#add-btn').on('click', function () {
                Bus.openDialogCfg('新增字典', 'systemSettings/dictionaryInner.html', '665px', '275px', winOptons);
            });
            //引入Page插件
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Api.admin + "/api/sys/SysDict/page", data, true, function (tableData, result) {
                        ...
                        $('.btn-check').click(function () {
                            ...
                            Bus.openDialog('查看字典', 'systemSettings/dictionaryInner.html?id=' + id, '665px', '275px');
                        });
                        $('.btn-change').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.openEditDialog('修改字典', 'systemSettings/dictionaryInner.html?id=' + id, '665px', '275px');
                        });
                        ...
                        $('.btn-add').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.openDialogCfg('添加键值', 'systemSettings/dictionaryInner.html?id=' + id + '&api=addKey', '665px', '275px',winOptons);
                        });
                    });
                    //动态添加Select的option
