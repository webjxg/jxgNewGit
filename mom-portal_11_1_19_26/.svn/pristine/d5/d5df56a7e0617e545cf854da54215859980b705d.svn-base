...
require(['/js/zlib/app.js'], function (App) {
    ...
    var PageModule = {
        ...
        createList2:function (data) {
            var htmls = '';
            for(var i=0;i<data.length;i++){
                htmls += "<li data-enable='"+ data[i].enable +"' data-id='"+data[i].nodeId+"'>"+data[i].nodename+"</li>";
            }
            $("#list2").html(htmls);
        ...
        createList3:function () {
            ...
            var htmls = '';
            for(var i=0;i<data.length;i++){
                htmls += "<li data-id='"+data[i].whsId+"'>"+data[i].nodeTank.nodename;
                if(data[i].nodeTank.enable == '1'){
