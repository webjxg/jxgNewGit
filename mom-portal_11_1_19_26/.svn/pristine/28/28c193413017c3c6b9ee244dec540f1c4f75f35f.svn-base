...
require(['/js/zlib/app.js'], function (App) {
    ...
    var PageModule = {
        listInit: function () {
            //动态添加Select的option
            //装置
            Bus.createSelect(Api.mtrl + '/api/fm/Unit/unitList', "#unitId", 'id', 'unitAlias');
            //新增=
            ...
            require(['Page'], function () {
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Api.mtrl +'/api/fm/ProCase/page', data, true, function (tableData) {
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该加工方案吗', Api.mtrl + '/api/fm/ProCase/delete', {ids:id});
                        });
                    });
            ...
            function renderTableData(tableData) {
                $('#treeTable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "caseNo", 'sClass': " alignCenter"},
                        {"data": "caseName", 'sClass': "alignCenter"},
                        {"data": "caseAlias", 'sClass': "alignCenter"},
                        {"data": "unit.unitAlias", 'sClass': "alignCenter"},
                        {"data": "isDft", 'sClass': "alignCenter",
                            "render": function (data, type, row, meta) {
        ...
        formInit: function () {
            ...
            var url = Api.mtrl + '/api/fm/ProCase/form/'+ id;
