                ...
                function renderTableData(tableData) {
                    $('#treeTable').dataTable({
                        ...
                        "aoColumns": [
                            ...
                            {
                                "data": "id", "orderable": false, "defaultContent": "", 'sClass': "autoWidth alignCenter ",
                                "render": function (data, type, row, meta) {
                ...
                $('#treeTable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "applicability",'sClass': "alignCenter"},
                        {
                            "data": "id", "orderable": false, "defaultContent": "", 'sClass': "autoWidth alignCenter ",
                            "render": function (data, type, row, meta) {
                                return "<a class='btn btn-delete' id='"+row.id+"' name='"+row.name+"'>移除</a >";
                            }
                        }]
                });
                renderIChecks();
                ...
                window.pageLoad= function () {
                    ...
                    function dataout(data) {
                        $('#treeTable').dataTable({
                            ...
                            "columns": [
                                {
                                    "data": null, 'sClass': "autoWidth alignCenter",
                                    "render": function (data, type, row, meta) {
