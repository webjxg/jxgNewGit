    ...
    $.fn.extendPagination = function (options) {
        ...
        if (totalPage > 0) {
            ...
            if(showPage > 0){
                ...
                html.push(' <li><span style="padding:0"><input type="text" id="curPg" style="width:40px;height:32px;border:none;text-align:center;" placeholder="页码" value="1"></span></li>');
