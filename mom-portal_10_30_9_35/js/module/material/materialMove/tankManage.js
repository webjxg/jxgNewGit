                        ...
                        Api.ajaxJson(Api.mtrl+'/api/mv/TankMtrlMove/getListByType', JSON.stringify(data), function (result) {
                            if (result.success) {
                                ...
                                if(isDlv==true){
                                    ...
                                    $('#ownMaterials').empty();
                                    $('#ownMaterials').append('<option value="'+result.nodeMtrlMove.dlvMtrl.id+'">'+result.nodeMtrlMove.dlvMtrl.mtrlName+'</option>')
                                    ...
                                    if(result.NodeList==undefined&&result.mtrlList==undefined) {
                                        if($('select#ownMaterials').length>0){
                                            ...
                                            attrInit('table tr td:nth-of-type(2)','#operationType,#startTime',false);
                                        }
                                    //正常操作
