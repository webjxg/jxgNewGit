                ...
                window.pageLoad = function (){
                    ...
                    Page.init(Api.admin+"/api/sys/SysApplication/page",data,true,function(tableData){
                        ...
                        $('.btn-check').click(function(){
                            ...
                            Bus.openDialog('查看应用','systemSettings/applicationInner.html?id='+id+'&api=view','640px','325px')
                        });
                        $('.btn-change').click(function(){
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.openEditDialog('修改应用','systemSettings/applicationInner.html?id='+id,'640px','325px');
                        });
                        $('.btn-delete').click(function(){
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该应用吗',Api.admin+'/api/sys/SysApplication/delete',id)
                        });
                        //点击重置按钮
                        $('#reset-btn').click(function(){
                            ...
                            $("#authCodeParam").val("");
                            $("#desParam").val();
                            Page.reset(["appNameParam","appCodeParam","enable","appDesParam"]);
                        });
                    });
                };
