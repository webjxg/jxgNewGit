        ...
        yearPLInit: function () {
            ...
            window.pageLoad = function () {
                ...
                require(['Page'], function () {
                    Page.init(Api.aps + "/api/aps/ApsYearPlan/page", data, true, function (tableDate) {
                        ...
                        $(".btn-delete").click(function () {
                            var attrArr = PageModule.getAttr($(this));
                            Bus.deleteItem('确定要删除该计划', Api.aps + '/api/aps/ApsYearPlan/delete', attrArr.id)
                        });
                        //编辑
        ...
        createTable: function (tableDate) {
            $('#treeTable').dataTable({
                ...
                "aoColumns": [
                    ...
                    {
                        "data": "yearName", "orderable": false, "defaultContent": "", 'sClass': "yearName alignCenter ",
                    ...
                    {"data": "typeLabel", 'sClass': "alignCenter "},                    {"data": "period", 'sClass': "alignCenter"},
