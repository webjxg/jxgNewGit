require(['/js/zlib/app.js'], function(App) {
  require(['dataTables'], function () {
	 require(['/js/plugins/websocket/stomp.min.js','/js/plugins/websocket/sockjs.min.js'], function () {
		var PageModule = {
			init:function(){
                $(".apsType-linkage li").eq(0).text(PageModule.getShortDate()+"  "+PageModule.getLocalTime());
				PageModule.connect();
			},
			connect:function(){
				var tryConnCount = 3;
