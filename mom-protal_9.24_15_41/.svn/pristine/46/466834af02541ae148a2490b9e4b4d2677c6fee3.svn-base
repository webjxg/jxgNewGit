    ...
    var PageModule = {
        listInit: function () {
            ...
            $('#add-btn').on('click', function () {
                Bus.openDialogCfg('新增字典', 'systemSettings/dictionaryInner.html', '665px', '305px', winOptons);
            });
            //引入Page插件
                ...
                window.pageLoad = function () {
                    ...
                    Page.init(Api.admin + "/api/sys/SysDict/page", data, true, function (tableData) {
                        ...
                        $('.btn-check').click(function () {
                            ...
                            Bus.openDialog('查看字典', 'systemSettings/dictionaryInner.html?id=' + id, '665px', '305px');
                        });
                        $('.btn-change').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.openEditDialog('修改字典', 'systemSettings/dictionaryInner.html?id=' + id, '665px', '305px');
                        });
                        ...
                        $('.btn-add').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.openDialogCfg('添加键值', 'systemSettings/dictionaryInner.html?id=' + id + '&api=addKey', '665px', '305px',winOptons);
                        });
                        //点击重置按钮
                ...
                $('#treeTable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"data": "enable", 'sClass': "alignCenter", "width": "12%",
                            "render": function (data, type, row, meta) {
                                return row.enable?"<i class='fa fa-check-square-o isChecked '></i>":"<i class='fa fa-square-o unCheck'></i>";
                            }
                        },
