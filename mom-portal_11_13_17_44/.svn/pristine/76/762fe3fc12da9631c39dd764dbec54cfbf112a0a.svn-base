...
require(['/js/zlib/app.js'], function (App) {
    var PageModule = {
        ...
        //加载数据 左上列表 右上列表 下拉选项
        loadData:function(){
            Api.ajaxJson(Api.mtrl + '/api/fm/MtrlInoutput/form/0',{},function (result) {
                if(result.success){
                    //工厂
        ...
        createList1:function (data) {
            ...
            $("#list1").on("click","li",function () {
                ...
                Api.ajaxJson(Api.mtrl +"/api/fm/MtrlInoutput/findList",data,function (result) {
                    if(result.success){
        ...
        createList2:function (data) {
            ...
            if(len>0){
                $.each(data,function(i,o){
                    htmls += "<li data-enable='"+ o.enable +"' data-id='"+o.mtrlId+"'>"+o.mtrl.mtrlName+"</li>";
                });
        ...
        createList3:function () {
            ...
            if(len>0){
                $.each(data,function(i,o){
                    htmls += "<li data-id='"+o.mtrlId+"'>"+o.mtrl.mtrlName;
        ...
        clickHandler:function () {
            ...
            $("#btn-left").unbind("click").on("click",function () {
                ...
                if(len<=0){
                    ...
                    if($("#list2").find(".active").length<=0){
                        ...
                        if(PageModule.dataList.length < 1){
            ...
            $("#btn-save").unbind("click").on("click",function(){
                ...
                var data = {
                    mtrlInoutput:JSON.stringify(mtrlInoutput)
                };
    ...
    $(function () {
        //料线料仓配置
        if ($('#configMaterilInputOutputModels').length > 0) {
            PageModule.init();
        }
    });
